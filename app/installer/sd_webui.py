...
LastEditTime: 2024-06-21 18:46:55
...
def install(app_card):
	print("Start install process (sd_webui)")

	app_url = "http://172.30.9.84:7860/chfs/shared/sd_webui/sd_webui-1.0.0.zip"
	temp_directory_path = os.path.join(tempfile.gettempdir(), 'aistore', 'sd_webui')
	Path(temp_directory_path).mkdir(parents = True, exist_ok = True)
	print(temp_directory_path)
