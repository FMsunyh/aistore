...
Date: 2024-06-18 10:55:15
LastEditors: Firmin.Sun fmsunyh@gmail.com
LastEditTime: 2024-06-19 15:00:59
FilePath: \aistore\app\core\filesystem.py
...
from app.core.common_helper import is_windows
...
def get_temp_frames_pattern(target_path : str, temp_frame_prefix : str) -> str:
	...
	return os.path.join(temp_directory_path, temp_frame_prefix + '.' + app.core.globals.temp_frame_format)
...
def get_temp_directory_path(target_path : str) -> str:
	...
	temp_directory_path = os.path.join(tempfile.gettempdir(), 'aistore')
	# return os.path.join(temp_directory_path, target_name)
	return os.path.join(temp_directory_path)
...
def clear_temp(target_path : str) -> None:
	...
	if not app.core.globals.keep_temp and is_directory(temp_directory_path):
